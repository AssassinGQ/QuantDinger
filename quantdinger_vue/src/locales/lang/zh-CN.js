...
const locale = {
  ...
  'menu.dashboard.brokerDashboard': '交易商看盘',
  ...
  'dashboard.indicator.section.ungrouped': '未分组',
  ...
  'dashboard.indicator.editor.group': '分组',
  ...
  'trading-assistant.groupByCustom': '自定义',
  'trading-assistant.form.displayGroup': '分组',
  ...
  'trading-assistant.form.strategyTypeSingleRegime': '单标 Regime 策略',
  'trading-assistant.form.strategyTypeCrossSectional': '截面策略',
  'trading-assistant.form.strategyTypeRegime': 'Regime 策略 (加权截面)',
  'trading-assistant.form.strategyTypeHint': '单标的策略：针对单个标的进行交易；单标 Regime：单标的 + 根据宏观 Regime 动态调整资金；截面策略：同时管理多个标的的组合；Regime 策略：根据宏观因子动态切换多风格指标',
  'trading-assistant.form.regimeStrategyType': 'Regime 风格',
  'trading-assistant.form.regimeStrategyTypeHint': '选择策略在不同宏观环境下的风险偏好：保守降低仓位，激进增加仓位',
  ...
  'trading-assistant.form.macroIndicators': '宏观指标',
  'trading-assistant.form.macroIndicatorsHint': '选择 Regime 策略使用的宏观指标，不同市场可使用不同指标（如美股用 VIX，港股用 VHSI，A股用 CIVIX）',
  'trading-assistant.form.primaryMacroIndicator': '主要宏观指标',
  'trading-assistant.form.primaryMacroIndicatorHint': '用于判断市场环境（regime）的主要宏观指标',
  'trading-assistant.form.regimeStyle': 'Regime 自动切换风格',
  'trading-assistant.form.regimeStyleNone': '不参与',
  'trading-assistant.form.regimeStyleConservative': '保守型',
  'trading-assistant.form.regimeStyleBalanced': '平衡型',
  'trading-assistant.form.regimeStyleAggressive': '激进型',
  'trading-assistant.form.regimeStyleHint': '启用 ENABLE_REGIME_SWITCH 后，将根据 VIX 自动启停：恐慌时仅运行保守型，低波动时可运行激进型',
  ...
  'trading-assistant.messages.rebalanceSuccess': '已成功触发策略重算',
  ...
  'trading-assistant.placeholders.regimeStyle': '选择参与 Regime 自动切换的风格（可选）',
  'trading-assistant.placeholders.selectPrimaryMacro': '请选择主要宏观指标',
  ...
  'broker.connected': 'IBKR 已连接',
  'broker.disconnected': 'IBKR 未连接',
  'broker.connect': '连接',
  'broker.disconnect': '断开',
  'broker.connectSuccess': 'IBKR 连接成功',
  'broker.connectFailed': 'IBKR 连接失败，请检查 IB Gateway',
  'broker.disconnectSuccess': '已断开 IBKR 连接',
  'broker.disconnectFailed': '断开连接失败',
  'broker.netLiquidation': '总权益',
  'broker.unrealizedPnl': '未实现盈亏',
  'broker.realizedPnl': '已实现盈亏',
  'broker.winRate': '胜率',
  'broker.profitFactor': '盈亏比',
  'broker.totalTrades': '总交易量',
  'broker.availableFunds': '可用资金',
  'broker.buyingPower': '购买力',
  'broker.marginUsed': '已用保证金',
  'broker.avgWin': '平均盈利',
  'broker.win': '盈',
  'broker.lose': '亏',
  'broker.filled': '已成交',
  'broker.currentPositions': '当前持仓',
  'broker.openOrders': '挂单',
  'broker.recentTrades': '最近交易',
  'broker.executions': '执单记录',
  'broker.strategyPnl': '策略盈亏',
  'broker.noPositions': '暂无持仓',
  'broker.noOrders': '暂无挂单',
  'broker.noTrades': '暂无交易记录',
  'broker.noExecutions': '暂无执单记录',
  'broker.noStrategyPnl': '暂无策略盈亏数据',
  ...
  'broker.col.type': '类型',
  'broker.col.limitPrice': '限价',
  'broker.col.status': '状态',
  'broker.col.progress': '进度',
  'broker.col.time': '时间',
  'broker.col.strategy': '策略',
  'broker.col.signalType': '信号',
  'broker.col.price': '价格',
  'broker.col.signalPrice': '信号价',
  'broker.col.fillPrice': '成交价',
  'broker.col.slippage': '滑点',
  'broker.col.profit': '盈亏',
  'broker.col.amount': '数量',
  'broker.col.timeInfo': '时间',
  'broker.col.totalTrades': '交易次数',
  'broker.col.totalValue': '总金额',
  'broker.col.totalCommission': '总佣金',
  ...
  'broker.signal.closeShort': '平空',
  'broker.signal.addLong': '加多',
  'broker.signal.addShort': '加空',
  'broker.status.pending': '待处理',
  'broker.status.processing': '处理中',
  'broker.status.completed': '已完成',
  'broker.status.failed': '失败',
  'broker.status.cancelled': '已取消'
}
