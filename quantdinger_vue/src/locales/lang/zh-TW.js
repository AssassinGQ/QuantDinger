...
const locale = {
  ...
  'trading-assistant.form.strategyTypeSingleRegime': '單標 Regime 策略',
  'trading-assistant.form.strategyTypeCrossSectional': '截面策略',
  'trading-assistant.form.strategyTypeRegime': 'Regime 策略（加權截面）',
  'trading-assistant.form.strategyTypeHint': '單標的策略：針對單一標的進行交易；單標 Regime：單一標的並依宏觀 Regime 動態調整資金；截面策略：同時管理多個標的之組合；Regime 策略：依宏觀因子動態切換多風格指標',
  'trading-assistant.form.regimeStrategyType': 'Regime 風格',
  'trading-assistant.form.regimeStrategyTypeHint': '選擇策略在不同宏觀環境下的風險偏好：保守降低倉位，激進增加倉位',
