...
const locale = {
  ...
  'trading-assistant.form.strategyTypeSingle': 'Stratégie sur un seul instrument',
  'trading-assistant.form.strategyTypeSingleRegime': 'Stratégie Regime sur un seul instrument',
  'trading-assistant.form.strategyTypeCrossSectional': 'Stratégie transversale',
  'trading-assistant.form.strategyTypeRegime': 'Stratégie Regime (pondération transversale)',
  'trading-assistant.form.strategyTypeHint': 'Instrument unique : négocier un seul symbole ; Regime unique : un symbole + ajustement dynamique du capital selon le régime macro ; Transversale : gérer un portefeuille multi-symboles ; Regime : alterner dynamiquement les styles d’indicateurs selon les facteurs macro',
  'trading-assistant.form.regimeStrategyType': 'Style Regime',
  'trading-assistant.form.regimeStrategyTypeHint': 'Choisissez la préférence de risque selon le macro : conservateur réduit la position, agressif l’augmente',
