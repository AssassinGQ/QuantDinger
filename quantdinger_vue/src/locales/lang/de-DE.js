...
const locale = {
  ...
  'trading-assistant.form.strategyTypeSingle': 'Ein-Symbol-Strategie',
  'trading-assistant.form.strategyTypeSingleRegime': 'Single-Regime-Strategie',
  'trading-assistant.form.strategyTypeCrossSectional': 'Querschnittsstrategie',
  'trading-assistant.form.strategyTypeRegime': 'Regime-Strategie (gewichteter Querschnitt)',
  'trading-assistant.form.strategyTypeHint': 'Ein Symbol: Handel mit einem Symbol; Single Regime: ein Symbol + dynamische Kapitalanpassung nach Makro-Regime; Querschnitt: Portfolio mit mehreren Symbolen; Regime: dynamischer Wechsel der Indikatorstile nach Makrofaktoren',
  'trading-assistant.form.regimeStrategyType': 'Regime-Stil',
  'trading-assistant.form.regimeStrategyTypeHint': 'Risikopräferenz je Makroumfeld wählen: konservativ reduziert die Position, aggressiv erhöht sie',
