...
const locale = {
  ...
  'menu.dashboard.brokerDashboard': 'Broker Dashboard',
  ...
  'dashboard.indicator.section.ungrouped': 'Ungrouped',
  ...
  'dashboard.indicator.editor.group': 'Group',
  ...
  'trading-assistant.groupByCustom': 'Custom',
  'trading-assistant.form.displayGroup': 'Group',
  ...
  'trading-assistant.form.strategyTypeSingleRegime': 'Single Regime Strategy',
  ...
  'trading-assistant.form.strategyTypeHint': 'Single Symbol: Trade a single symbol; Single Regime: Single symbol + dynamic capital adjustment by macro regime; Cross-Sectional: Manage a portfolio; Regime: Dynamic switch styles based on macro factors',
  'trading-assistant.form.regimeStrategyType': 'Regime Style',
  'trading-assistant.form.regimeStrategyTypeHint': 'Choose the risk preference under different macro regimes: Conservative reduces position, Aggressive increases position',
  ...
  'trading-assistant.form.macroIndicators': 'Macro Indicators',
  'trading-assistant.form.macroIndicatorsHint': 'Select macro indicators for regime detection. Different markets may use different indicators (e.g., VIX for US stocks, VHSI for HK stocks, CIVIX for A-shares)',
  'trading-assistant.form.primaryMacroIndicator': 'Primary Macro Indicator',
  'trading-assistant.form.primaryMacroIndicatorHint': 'The primary macro indicator used to determine market regime',
  'trading-assistant.form.regimeStyle': 'Regime Auto-Switch Style',
  'trading-assistant.form.regimeStyleNone': 'Do not participate',
  'trading-assistant.form.regimeStyleConservative': 'Conservative',
  'trading-assistant.form.regimeStyleBalanced': 'Balanced',
  'trading-assistant.form.regimeStyleAggressive': 'Aggressive',
  'trading-assistant.form.regimeStyleHint': 'When ENABLE_REGIME_SWITCH is on, strategies are started/stopped by VIX: panic runs conservative only; low vol can run aggressive',
  ...
  'trading-assistant.messages.rebalanceSuccess': 'Rebalance triggered successfully',
  ...
  'trading-assistant.placeholders.regimeStyle': 'Select style for Regime auto-switch (optional)',
  'trading-assistant.placeholders.selectPrimaryMacro': 'Select primary macro indicator',
  ...
  // Broker Dashboard (IBKR)
  'broker.connected': 'IBKR Connected',
  'broker.disconnected': 'IBKR Disconnected',
  'broker.connect': 'Connect',
  'broker.disconnect': 'Disconnect',
  'broker.connectSuccess': 'IBKR connected successfully',
  'broker.connectFailed': 'IBKR connection failed, check IB Gateway',
  'broker.disconnectSuccess': 'IBKR disconnected',
  'broker.disconnectFailed': 'Disconnect failed',
  'broker.netLiquidation': 'Net Liquidation',
  'broker.unrealizedPnl': 'Unrealized P&L',
  'broker.realizedPnl': 'Realized P&L',
  'broker.winRate': 'Win Rate',
  'broker.profitFactor': 'Profit Factor',
  'broker.totalTrades': 'Total Trades',
  'broker.availableFunds': 'Available Funds',
  'broker.buyingPower': 'Buying Power',
  'broker.marginUsed': 'Margin Used',
  'broker.avgWin': 'Avg Win',
  'broker.win': 'W',
  'broker.lose': 'L',
  'broker.filled': 'Filled',
  'broker.currentPositions': 'Current Positions',
  'broker.openOrders': 'Open Orders',
  'broker.recentTrades': 'Recent Trades',
  'broker.executions': 'Execution Records',
  'broker.strategyPnl': 'Strategy P&L',
  'broker.noPositions': 'No positions',
  'broker.noOrders': 'No open orders',
  'broker.noTrades': 'No trade records',
  'broker.noExecutions': 'No execution records',
  'broker.noStrategyPnl': 'No strategy P&L data',
  ...
  'broker.col.limitPrice': 'Limit',
  'broker.col.status': 'Status',
  'broker.col.progress': 'Progress',
  'broker.col.time': 'Time',
  'broker.col.strategy': 'Strategy',
  'broker.col.signalType': 'Signal',
  'broker.col.price': 'Price',
  'broker.col.signalPrice': 'Signal Price',
  'broker.col.fillPrice': 'Fill Price',
  'broker.col.slippage': 'Slippage',
  'broker.col.profit': 'P&L',
  'broker.col.amount': 'Amount',
  'broker.col.timeInfo': 'Time',
  'broker.col.totalTrades': 'Total Trades',
  'broker.col.totalValue': 'Total Value',
  'broker.col.totalCommission': 'Total Commission',
  ...
  'broker.signal.closeShort': 'Close Short',
  'broker.signal.addLong': 'Add Long',
  'broker.signal.addShort': 'Add Short',
  'broker.status.pending': 'Pending',
  'broker.status.processing': 'Processing',
  'broker.status.completed': 'Completed',
  'broker.status.failed': 'Failed',
  'broker.status.cancelled': 'Cancelled'
}
