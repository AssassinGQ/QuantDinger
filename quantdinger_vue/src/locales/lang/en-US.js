...
const locale = {
  ...
  'regime.tabs.view': 'View',
  'regime.tabs.config': 'Config',
  'regime.view.currentRegime': 'Current Regime',
  'regime.view.vix': 'VIX',
  'regime.view.fearGreed': 'Fear & Greed',
  'regime.view.weights': 'Weights',
  'regime.view.strategyGroups': 'Strategy Groups',
  'regime.view.noConfig': 'No config yet',
  'regime.view.resetCircuitBreaker': 'Reset Circuit Breaker',
  'regime.view.resetSuccess': 'Circuit breaker reset',
  'regime.config.createMode': 'Create Mode',
  'regime.config.formMode': 'Form',
  'regime.config.yamlMode': 'Import YAML',
  'regime.config.uploadYaml': 'Upload YAML',
  'regime.config.yamlPreview': 'Parsed Preview',
  'regime.config.confirmSave': 'Confirm & Save',
  'regime.config.yamlParsed': 'YAML parsed',
  'regime.config.indicatorTitle': 'Regime Indicator Config',
  'regime.config.primaryIndicator': 'Primary Indicator',
  'regime.config.vixPanic': 'Panic threshold',
  'regime.config.vixHighVol': 'High vol threshold',
  'regime.config.vixLowVol': 'Low vol threshold',
  'regime.config.vixHint': 'VIX: > panic = panic, > high_vol = high vol, < low_vol = low vol',
  'regime.config.fgExtremeFear': 'Extreme fear threshold',
  'regime.config.fgHighFear': 'High fear threshold',
  'regime.config.fgLowGreed': 'Low greed threshold',
  'regime.config.fgHint': 'Fear & Greed 0-100: low = fear, high = greed',
  'regime.config.customCode': 'Custom Python',
  'regime.config.customCodeLabel': 'Python Code',
  'regime.config.customCodePlaceholder': '# Available: macro.vix, macro.dxy, macro.fear_greed\n# Define regime or regime_score\nregime_score = 100 - macro["fear_greed"]  # or: regime = "normal"',
  'regime.config.customCodeHint': 'Define regime (panic/high_vol/normal/low_vol) or regime_score (0-100, mapped by thresholds below)',
  'regime.config.customCodeRequired': 'Please enter custom code',
  'regime.config.verifyCode': 'Verify & Run',
  'regime.config.verifySuccess': 'Verify success',
  'regime.config.customScoreExtremeFear': 'Score extreme fear threshold',
  'regime.config.customScoreHighFear': 'Score high fear threshold',
  'regime.config.customScoreLowGreed': 'Score low greed threshold',
  'regime.config.customScoreHint': 'When regime_score: score < extreme_fear → panic, < high_fear → high_vol, > low_greed → low_vol',
  'regime.config.strategyBinding': 'Strategy Binding',
  'regime.config.addSymbol': 'Add Symbol',
  'regime.config.weights': 'Weights',
  'regime.config.enableMultiStrategy': 'Enable multi-strategy weights',
  'regime.config.saved': 'Config saved',
  'regime.config.save': 'Save Config',
