# Requirements Archive: v1.1 Tech Debt Cleanup + Limit Orders
...
- [x] **TRADE-02**: 限价单部分成交处理——orderStatus PartiallyFilled 正确更新 remaining，不重复计入 fills/positions
- [x] **TRADE-03**: 限价单策略自动化——StatefulClientRunner 支持 limit order 信号，PendingOrderWorker 传递 limit price
...
| TRADE-02 | Phase 17 | Complete |
| TRADE-03 | Phase 17 | Complete |
