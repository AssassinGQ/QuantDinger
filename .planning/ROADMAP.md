...
Plans:
- [ ] `18-01-PLAN.md` — Shared `tests/helpers` IBKR mocks + Flask strategy fixture + refactor smoke/E2E imports (enables TRADE-05/06 + TEST-02)
- [ ] `18-02-PLAN.md` — Qualify-cache E2E + TRADE-05 XAGUSD mock chain (`test_e2e_qualify_cache_ibkr.py`)
- [ ] `18-03-PLAN.md` — Limit fill/partial/cancel + error paths (`test_e2e_limit_cancel_errors_ibkr.py`, TRADE-06)
- [ ] `18-04-PLAN.md` — USStock/HShare cross-market E2E (`test_e2e_cross_market_usstock_hshare_ibkr.py`)
- [ ] `18-05-PLAN.md` — Strategy HTTP CRUD + batch (`test_strategy_http_e2e.py`, TEST-02)
...
| 18. E2E & integration testing | v1.1 | 0/6 | Not started | — |
