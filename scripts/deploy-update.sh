...
echo "[2/4] SSH 容器编译前端..."
ssh -p 322 root@hgq-nas "cd /home/workspace/ws/QuantDinger/quantdinger_vue && npm run build 2>/dev/null || (npm install --legacy-peer-deps && npm run build)"
...
ssh admin@hgq-nas "export PATH=/share/CACHEDEV1_DATA/.qpkg/container-station/bin:\$PATH && cd /share/Data2/ubuntu/ws/QuantDinger && bash scripts/update-frontend-in-docker.sh"
