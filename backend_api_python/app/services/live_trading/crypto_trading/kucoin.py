...
from app.services.live_trading.base import BaseRestfulClient, LiveOrderResult, LiveTradingError
from app.services.live_trading.crypto_trading.symbols import to_kucoin_symbol


class KucoinSpotClient(BaseRestfulClient):
    def __init__(
        self,
        *,
        api_key: str,
...
class KucoinFuturesClient(BaseRestfulClient):
    """
    ...
    def get_contract(self, *, symbol: str) -> Dict[str, Any]:
        from app.services.live_trading.crypto_trading.symbols import to_kucoin_futures_symbol
