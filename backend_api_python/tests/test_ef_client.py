...
class TestEFClient:
    ...
    def test_is_market_open_outside_hours(self):
        """Test is_market_open returns False outside trading hours."""
        config = EFConfig(account_id="123456789", password="test_pass")
        client = EFClient(config)
        with patch(
            "app.services.live_trading.ef_trading.client.MarketHours.is_trading_time",
            return_value=(False, "A\u80a1 \u5f53\u524d\u975e\u4ea4\u6613\u65f6\u95f4"),
        ):
