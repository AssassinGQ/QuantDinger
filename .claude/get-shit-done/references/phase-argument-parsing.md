...
```bash
PHASE_INFO=$(node "/home/hgq/workspace/aicoder/ws4/QuantDinger/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/home/hgq/workspace/aicoder/ws4/QuantDinger/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/home/hgq/workspace/aicoder/ws4/QuantDinger/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
