...
- **Global scope**: `/home/workspace/ws/QuantDinger/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/workspace/ws/QuantDinger/.claude/notes/`)
...
2. Glob `/home/workspace/ws/QuantDinger/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/workspace/ws/QuantDinger/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/workspace/ws/QuantDinger/.claude/notes/` — works in any directory
