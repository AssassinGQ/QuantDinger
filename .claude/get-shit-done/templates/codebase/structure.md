...
- Usage: Reference from command with `@/home/hgq/workspace/aicoder/ws4/QuantDinger/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/hgq/workspace/aicoder/ws4/QuantDinger/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/hgq/workspace/aicoder/ws4/QuantDinger/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
