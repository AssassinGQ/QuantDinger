...
<!-- For checkpoint task examples and patterns, see @/home/workspace/ws/QuantDinger/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/workspace/ws/QuantDinger/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/workspace/ws/QuantDinger/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/workspace/ws/QuantDinger/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
