...
<required_reading>
@/home/workspace/ws/QuantDinger/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/workspace/ws/QuantDinger/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
