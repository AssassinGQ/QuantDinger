...
<reference>
@/home/workspace/ws/QuantDinger/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/workspace/ws/QuantDinger/.claude/get-shit-done/references/user-profiling.md` to load:
