...
Reference full template: `/home/workspace/ws/QuantDinger/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/workspace/ws/QuantDinger/.claude/get-shit-done/templates/state.md`.
